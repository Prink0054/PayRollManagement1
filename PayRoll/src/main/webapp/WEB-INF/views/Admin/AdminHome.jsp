...
<br><br><br>
<input type="button" id="btnShow" value="Employee Record"" style="background: #000000; border-radius: 10px; padding: 7px 0; color: #fff; width: 210px;height: 37px""><br><br><br>
...
<table id="customers">
  ...
  <c:forEach items="${adminInbox}" var="inbox">
  <tr>
    <td>${inbox.from.email}</td>
    <td>${inbox.msgBody}</td>
    <td>${inbox.date}</td>
 
    <td align="center"><a href="/PayRoll/deleteMessage?getId=${inbox.id}"><img src="resources/images/crossIcon.jpg" width="20" height="20"></a></td>
...
<table id="customers">
  ...
  <c:forEach items="${adminOutbox}" var="outbox">
  <tr>
    <td>${outbox.to.email}</td>
    <td>${outbox.msgBody}</td>
    <td>${outbox.date}</td>
 
    <td align="center"><a href="/PayRoll/deleteMessage?getId=${outbox.id}"><img src="resources/images/crossIcon.jpg" width="20" height="20"></a></td>
...
<form action="/PayRoll/sendMessage" method="POST" >
<table>
<tr>
<td>From:</td>
<td>
...
<div id="dialog7" style="display: none" align = "center">
 ...
 <table id="customers">
  ...
  <tr>
    ...
    <td align="center"><a href="/PayRoll/salaryInfo?getEmail=${emps.email}"><img src="resources/images/payslip.png" width="20" height="20"></a></td>
